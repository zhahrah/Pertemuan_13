...
void insert_data(); //membluat fungsi insert_data
void hapus_data(); // membuat fungsi hapus_data
void cetak_data(); //membuat fungsi cetak_data
struct node         //membuat tipe data struct yang berfungsi menyimpan beberapa tipe data yg berbeda
{
 int nomorinduk;
 char nama [40];
 char gender [20];
